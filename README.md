...
1. Clone the repo:
   ```sh
   git clone https://github.com/rajpoot-arunesh/JobPortal_MERN.git
   ```
...
Arunesh Kumar - [GitHub](https://github.com/rajpoot-arunesh)

Project Link: [https://github.com/rajpoot-arunesh/JobPortal_MERN.git](https://github.com/rajpoot-arunesh/JobPortal_MERN.git)
